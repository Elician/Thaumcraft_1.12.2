    ...
    public void onUpdate() {
        ...
        if (!this.world.isRemote) {
            ...
            if (!this.points.isEmpty()) {
                ...
                v1 = ((Vec3d)this.points.get(pi)).add(new Vec3d(this.posX, this.posY, this.posZ));
                Vec3d v2 = ((Vec3d)this.points.get(pi + 1)).add(new Vec3d(this.posX, this.posY, this.posZ));
                ...
                if (rt != null && rt.getBlockPos() != null) {
                    ...
                    if (!this.world.isAirBlock(p) && bs.getBlockHardness(this.world, p) >= 0.0F && bs.getBlock().canCollideCheck(bs, false)) {
                        GDClaim gclaim=GriefDefenderPlugin.getInstance().dataStore.getClaimAt(new Location((Extent) this.world,this.posX,this.posY,this.posZ));
                        if(gclaim!=null) {
                            String s = gclaim.getOwnerName();
                            if(s=="wilderness") {
